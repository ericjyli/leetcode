...
ListNode* partition(ListNode* head, int x) {
    ...
    struct ListNode* smallHead = new struct ListNode;
    struct ListNode* largeHead = new struct ListNode;
    ...
    while (temp && temp -> next){
        if (temp -> val < x){
            if (temp == small){
                ...
                smallMove -> next = new struct ListNode;
            ...
            if (temp == large){
                ...
                largeMove -> next = new struct ListNode;
